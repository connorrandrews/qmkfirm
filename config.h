...
#define MATRIX_ROWS_MCU 6
#define MATRIX_COLS_MCU 7
#define MATRIX_ROWS_MCP 6
#define MATRIX_COLS_MCP 9
#define MATRIX_ROWS_PER_SIDE MATRIX_ROWS_MCU
#define MATRIX_COLS_PER_SIDE (MATRIX_COLS_MCU + MATRIX_COLS_MCP)
